...
hist(bootstrap_means_F, breaks = 20, add = TRUE, col = "grey")
...
bca <- bca(bootstrap_means, CI)
c("BCa CI", bca)
hist(bootstrap_means, breaks = 20, xlab = "Mean of bootstrapped subsamples (age)", ylab = "Frequency", main = "CI bootstrapped subsamples for Male survivor data (n=50)")
abline(v = lower, col = "red")
abline(v = upper, col = "red")
abline(v = bca[1], col = "blue")
abline(v = bca[2], col = "blue")
